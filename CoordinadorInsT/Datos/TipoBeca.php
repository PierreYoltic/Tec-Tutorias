...
<body>
        ...
        <div class="menu-list">
            ...
            <ul id="menu-content" class="menu-content collapse out">
                ...
                <ul class="sub-menu collapse" id="datos">
                    ...
                    <li class="active"><a href="TipoBeca.php">Tipo de Beca</a></li>
                    <li><a href="ConQuienVives.php">Con quien vives</a></li>
    ...
    <div class="container-fluid mt-5 p-5 mb-3 offset-lg-3 col-lg-8 offset-md-4 col-md-7 col-12"
        ...
        <div class="row col-12 justify-content-center">
            <h3 class="col-12 text-center">Tipos de Becas</h3>
            <hr>
            <div id="consTipoBeca" class="col-12 col-lg-6"></div>
        </div>
    </div>
    ...
    <script>
        $(document).ready(function () {
            $.ajax({
                url: "Consultas/consTipoBeca.php",
                type: "GET",
                success: function (response) {
                    $('#consTipoBeca').html(response);
                }
            });
        })
    </script>

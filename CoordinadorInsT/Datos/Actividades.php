...
<body>
        ...
        <div class="menu-list">
            ...
            <ul id="menu-content" class="menu-content collapse out">
                ...
                <ul class="sub-menu collapse" id="datos">
                    ...
                    <li><a href="TipoBeca.php">Tipo Beca</a></li>
    ...
    <div class="container-fluid mt-5 p-5 mb-3 offset-lg-3 col-lg-8 offset-md-4 col-md-7 col-12"
        ...
        <div class="row col-12 justify-content-center">
            <h3 class="col-12 text-center">Actividades</h3>
            <hr>
            <form id="formActividades" class="col-12 col-lg-6">
                <label>Registrar actividades</label>
                <textarea id="concepto" cols="30" rows="3" class="form-control form-control-sm"
                    placeholder="Concepto de la Actividad" maxlength="100"></textarea>
                <input type="submit" value="Registrar" class="btn btn-success mt-2">
            </form>
            <div id="consActividades" class="col-12 col-lg-6"></div>
        </div>
    </div>
    ...
    <script>
        $(document).ready(function () {
            ...
            function actTabla() {
                $.ajax({
                    url: "Consultas/consActividades.php",
                    type: "GET",
                    success: function (response) {
                        $('#consActividades').html(response);
                    }
                });
            }
            actTabla();
            ...
            $("#formActividades").submit(function (e) {
                ...
                if ($('#concepto').val().length > 0) {
                    ...
                    $.post('Registrar/regActividad.php', postData, function (response) {

        ...
        <div class="menu-list">
            ...
            <ul id="menu-content" class="menu-content collapse out">
                ...
                <li data-toggle="collapse" data-target="#datos" class="collapsed">
                    <a href="#"><i class="fa fa-address-book fa-lg"></i> Información general <span class="arrow"></span></a>
                </li>
                ...
                <li data-toggle="collapse" data-target="#registrar" class="collapsed">
                    <a href="#"><i class="fa fa-address-book fa-lg"></i> Datos personal/alumnos<span class="arrow"></span></a>
                </li>
                <ul class="sub-menu collapse" id="registrar">
                    <li><a href="DatosPersonal/RegistrarPersonal.php">Registrar personal-usuarios</a></li>
                    <li><a href="DatosPersonal/SubDirectorAcad.php">Subdirector Académico</a></li>

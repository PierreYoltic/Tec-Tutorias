...
<body>
    ...
    <div class="container-fluid mt-5 p-5 mb-3 offset-lg-3 col-lg-8 offset-md-4 col-md-7 col-12"
        ...
        <div class="row col-12 justify-content-center">
            <h3 class="col-12 text-center">Materias</h3>
            <hr>
            <div id="opcCarreras" class="col-12 col-lg-7 col-md-8"></div>
            <div id="tblCarreras" class="col-12 col-lg-8 col-md-12"></div>
        </div>
    </div>
    <!-- ComboBox Carreras -->
    <script>
        $(document).ready(function () {
            $.ajax({
                url: "Opciones/opcCarreras.php",
                type: "GET",
                success: function (response) {
                    $('#opcCarreras').html(response);
                }
            });
        })
    </script>
    ...
    <script>
        $(document).ready(function () {
            $("#opcCarreras").change(function (e) {
                idCarrera = $('#opcCarreras option:selected').val();
                console.log(idCarrera);
                if (idCarrera != 0) {
                    $.ajax({
                        url: "Consultas/consMatXCarrera.php?idCarrera=" + idCarrera,
                        type: "GET",
                        success: function (response) {
                            $('#tblCarreras').html(response);
                        }
                    });
                }
            });
